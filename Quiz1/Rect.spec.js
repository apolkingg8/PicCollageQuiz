...
it('can be init', () => {
    // w,h must > 0
    expect(() => { new Rect_1.default(0, 0, 0, 0); }).toThrow();
    expect(() => { new Rect_1.default(0, 0, -1, -1); }).toThrow();
    let rect = new Rect_1.default(0, 0, 1, 1);
    expect(rect).toBeInstanceOf(Rect_1.default);
...
it('isIntersectionWith works', () => {
    // intersection
    let rect1 = new Rect_1.default(0, 0, 2, 2);
    let rect2 = new Rect_1.default(1, 1, 2, 2);
    expect(rect1.isIntersectionWith(rect2)).toEqual(true);
    expect(rect2.isIntersectionWith(rect1)).toEqual(true);
    // intersection with point
    let rect3 = new Rect_1.default(0, 0, 2, 2);
    let rect4 = new Rect_1.default(2, 2, 2, 2);
